						    ...
						    <tr>
						      ...
						      <td>
						      	<div class="action-icons">
						      		<ul>
						      			<li><a href="{{ route('writerimage.edit', $WriterImage->id )}}"><i class="fa fa-edit"></i></a></li>
						      			<li><a href="" data-toggle="modal" data-target="#deleteContent{{$WriterImage->id}}"><i class="fa fa-trash"></i></a></li>
						      		</ul>
						      		<!---delete modal start------>

						      		<!-- Modal -->
									<div class="modal fade" id="deleteContent{{$WriterImage->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
									  <div class="modal-dialog">
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="{{ route('writerimage.destroy', $WriterImage->id) }}" method="POST">
									@csrf
								<div class="action-icons">
									<ul>
