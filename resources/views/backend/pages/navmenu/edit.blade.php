	  		...
	  		<div class="col-sm-12 col-xl-12">
	  			...
	  			<div class="card bd-0 shadow-base">
	  				...
	  				<div class="pd-1-25 pd-r-15 pd-b-25">
	  					<form action="{{ route('navmenu.update', $nav->id) }}" method="POST" enctype="multipart/form-data">
	  						<!---------this is security token-------->
	  						@csrf

	  						<div class="form-group">
	  							<label>Nav Text</label>
	  							<input type="text" name="nav_text" class="form-control" value="{{ $nav->nav_text}}">
	  							...
	  							<input type="text" name="nav_url" class="form-control" value="{{ $nav->nav_url}}">
