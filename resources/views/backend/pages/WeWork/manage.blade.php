	  				...
	  				<div class="pd-1-25 pd-r-15 pd-b-25">
						  ...
						  <tbody>
						    ...
						    <tr>
						      ...
						      <td>{{ $WeWork->title}}</td>
						      <td>{{ $WeWork->paragraph_one}}</td>
						      <td>{{ $WeWork->paragraph_two}}</td>
						      <td>{{ $WeWork->paragraph_three}}</td>
						      <td>{{ $WeWork->button_text}}</td>
						      <td>{{ $WeWork->button_url}}</td>
						      ...
						      <td>
						      	<div class="action-icons">
						      		<ul>
						      			<li><a href="{{ route('wework.edit', $WeWork->id )}}"><i class="fa fa-edit"></i></a></li>
						      			<li><a href="" data-toggle="modal" data-target="#deleteContent{{$WeWork->id}}"><i class="fa fa-trash"></i></a></li>
						      		</ul>
						      		<!---delete modal start------>

						      		<!-- Modal -->
									<div class="modal fade" id="deleteContent{{$WeWork->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
									  <div class="modal-dialog">
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="{{ route('wework.destroy', $WeWork->id) }}" method="POST">
									@csrf
								<div class="action-icons">
									<ul>
