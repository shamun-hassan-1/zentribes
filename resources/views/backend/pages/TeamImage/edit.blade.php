	  		...
	  		<div class="col-sm-12 col-xl-12">
	  			...
	  			<div class="card bd-0 shadow-base">
	  				...
	  				<div class="pd-1-25 pd-r-15 pd-b-25">
	  					<form action="{{ route('teamimage.update', $TeamImage->id) }}" method="POST" enctype="multipart/form-data">
	  						<!---------this is security token-------->
	  						@csrf

	  						<div class="form-group">
	  							<label>Add Title</label>
	  							<input type="text" name="title" class="form-control" value="{{ $TeamImage->title}}">
