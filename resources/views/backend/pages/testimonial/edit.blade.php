	  				...
	  				<div class="pd-1-25 pd-r-15 pd-b-25">
	  					<form action="{{ route('testimonial.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
	  						...
	  						<div class="form-group">
	  							...
	  							<input type="text" name="author_title" class="form-control" value="{{ $testimonial->author_title}}">
	  							
	  						</div>
	  						<div class="form-group">
	  							<label>Author Position</label>
	  							<input type="text" name="author_position" class="form-control" value="{{ $testimonial->author_position}}">
