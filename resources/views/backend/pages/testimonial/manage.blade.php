	  				...
	  				<div class="pd-1-25 pd-r-15 pd-b-25">
						  ...
						  <thead>
						    <tr>
						      ...
						      <th scope="col">author_title</th>
						      <th scope="col">author_position</th>
						  ...
						  <tbody>
						    ...
						    <tr>
						      ...
						      <td>
						      	...
						      	<img src="{{ asset('Backend/img/testimonial' )}}/{{ $testimonial->image }}" width="40">
						      ...
						      <td>
						      	<div class="action-icons">
						      		<ul>
						      			<li><a href="{{ route('testimonial.edit', $testimonial->id )}}"><i class="fa fa-edit"></i></a></li>
						      			<li><a href="" data-toggle="modal" data-target="#deleteContent{{$testimonial->id}}"><i class="fa fa-trash"></i></a></li>
						      		</ul>
						      		<!---delete modal start------>

						      		<!-- Modal -->
									<div class="modal fade" id="deleteContent{{$testimonial->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
